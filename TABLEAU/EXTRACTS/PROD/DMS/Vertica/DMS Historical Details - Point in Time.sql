/*
FILENAME: DMS HISTORICAL DETAILS PIT
CREATED BY: Lorraine Christian
LAST UPDATED: 01/12/2022
CHANGES MADE: Vertica Migration.
CHANGES MADE: PROD CREDIT SWAPPED PG 10/20/22
CHANGES MADE:  Fields added to support Work Distribution
CHANGES MADE:  10/13/2023 - Logged by now in mart removed join to dma_vw.dma_dim_employee_pit_vw AS T4
*/
...
FROM dma_vw.fact_integrated_dms_pit_vw T1
----NO IGO GOAL FOR DMS
