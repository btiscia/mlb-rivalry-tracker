/* 
This routine provides Historical Point in Time for ServiceCenter
* Peer Review & Change Log: 
* Peer Review Date: 
* Source for this routine is PROD_DMA_VW.TRANS_PIT_INTEGRATED_VW
*Created: NA
*Revision Made: 7/8/2019
*Revisions: Pending removed entirely, added time stamp - Kristin Carlile
*Revision Made: 8/11/2020
*Revisions:  Requestor Type, Requestor Name and SourceFirmNumber  added.  Revision by Lorraine Christian
*Revision Made 1/25/2021 Removed dept ID 2 from query, DI has theirown data mart now - Kristin Carlile
*/
...
FROM PROD_DMA_VW.TRANS_PIT_INTEGRATED_VW
WHERE (WorkEventDepartmentID IN (29,30,31,32,33,34)
OR DepartmentID IN (29,30,31,32,33,34))
