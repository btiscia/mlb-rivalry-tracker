/*
FILENAME: DATA QUALITY HISTORICAL DETAILS CURRENT
CREATED BY: John Avgoutakis
LAST UPDATED: 3/16/2022
CHANGES MADE: Vertica SQL Creation.
CHANGES MADE:  Prod Credit Swap 10/25/2022 LC
*/
...
SELECT
	...
	, T1.prod_credit AS "Productivity Credits"  -- added 10/25/22
	--, T1.current_prod_credit AS "Productivity Credits" -- Removed 10/25/2022
...
FROM dma_vw.fact_integrated_dq_curr_vw T1
