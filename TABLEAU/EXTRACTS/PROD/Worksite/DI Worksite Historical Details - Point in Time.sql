/*
FILENAME: DI Worksite Historical Details - Point in Time
...
FROM dma_vw.fact_integrated_diwkst_pit_vw T1
...
AND CAST(T1.report_dt AS DATE)>= CURRENT_DATE - INTERVAL '3' YEAR