/*  
FILENAME: LNB FEI NB Time Service
...
SELECT 
	fei_wobs.r_workobjectstepkey AS "Work Item Number"
	, fei_wobs.r_wobnum AS "Work Item ID"
...
WHERE
	...
	AND fei_wobs.pe_snbtransactiontype LIKE 'DI%'
