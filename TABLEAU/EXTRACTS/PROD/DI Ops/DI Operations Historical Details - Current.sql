...
*  Revised: 6/3/2021 - Added DaysPastTAT - KC
...
FROM PROD_DMA_VW.ACT_DIO_CURR_INTEGRATED_VW T1  --Removed this mart PSC_MART_CURR_IVW T1
...
JOIN (SELECT DISTINCT
                ...
                FROM PROD_dma_vw.act_DIO_integrated_fct_vw AS a
