/*
FILENAME: EGL OPS DAILY TRANSACTIONS
CREATED BY: Lorraine Christian
LAST UPDATED: 5/16/2022
CHANGES MADE: Points to Vertica.
*/
...
SELECT
	...
	--, CASE WHEN source_system_id = 24 THEN T1.prod_credit ELSE T1.current_prod_credit END AS "Productivity Credits"
        , T1.prod_credit AS "Productivity Credits" --added this and removed above case source_system_id not in EGL 
