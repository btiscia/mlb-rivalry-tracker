...
, CASE 
	WHEN T1.last_item_type = 'Payment Transaction - TD' THEN 'Total' 
	WHEN T1.last_item_type = 'Payment Transaction - PD' THEN 'Partial'
...
, T1.last_item_dt AS "Past Due Check Amount"
