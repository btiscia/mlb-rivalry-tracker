/*
FILENAME: DI CLAIMS RESTRICTED CASELOAD INVENTORY DETAILS
...
--AND T1.short_claim_num = '18-00030'
--AND T5.short_dt = '2022-05-11'
--AND T1.claim_status_category = 'Active Pending'
--AND T1.claim_category = 'Disability'
--AND T1.base_claim_ind = 1