...
,"Team Name"
,"Role Name"
,(SELECT GoalValue FROM PROD_DMA_VW.GOAL_DIM_VW WHERE EndDate = '9999-12-31' AND DepartmentID = 4 AND GoalTypeID = 3 AND RoleName = T1."Role Name") AS "Prod Goal"
,(SELECT GoalValue FROM PROD_DMA_VW.GOAL_DIM_VW WHERE EndDate = '9999-12-31' AND DepartmentID = 4 AND GoalTypeID = 4 AND RoleName = T1."Role Name") AS "Non Prod Goal"
,"Actual Flex Hours"
